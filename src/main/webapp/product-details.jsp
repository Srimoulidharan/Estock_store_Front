...
<div class="container my-5">
    <%
        ...
        try {
            ...
            stmt = conn.prepareStatement("SELECT product_id, name, description, price, image FROM products WHERE product_id = ?");
            stmt.setInt(1, id);
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="CartServlet" method="post" id="productForm">
                ...
                <button type="submit" name="action" value="buyNow" class="btn btn-success ms-2">Buy Now</button>
            </form>
